package com.greenkey20.innerorbit.ai.application.service;
...
/**
 * AiUseCase 구현체 — Spring AI ChatClient를 사용하여 OpenAI GPT 모델과 통신
 * LogRepository 의존 제거: recentLogsContext는 파라미터로 수신
 */
@Service
